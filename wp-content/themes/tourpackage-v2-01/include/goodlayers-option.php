	...
	*/
	...
	$goodlayers_element = array(
		...
		'gdl_panel_package_translator' => array(
			...
			__('LOCATION (SINGLE PACKAGE)', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_translator_location_package','default'=>'Class:'),		
			...
			__('LOCATION (SEARCH PACKAGE)', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_translator_search_location_package','default'=>'Class'),		
