...
<div class="content-outer-wrapper">
	...
	<?php
		...
		if( $gdl_admin_translator == 'enable' ){
			...
			$translator_price = get_option(THEME_SHORT_NAME.'_translator_price_package', 'Price from:');
		...
		<?php
			...
			if ( have_posts() ){
				while (have_posts()){
					...
					$id_slider = get_post_meta(get_the_ID(), 'page-option-layer-slider-id',true);
					
					if(!empty($id_slider)){
						layerslider($id_slider);
					}
